...
\begin{figure}
\centering
\begin{overpic}[width =0.9\columnwidth]{exp11_compare.pdf}\end{overpic}
...
%To ensure all measurements had the same attenuation and were synchronous, the previous test  connected the seismic drone to a cabled system.  This experiment demonstrates that the onboard GSR records seismic disturbances.
   ...
   \begin{figure}
   \centering
\begin{overpic}[width =0.7\columnwidth]{shot_gather_compare.pdf}\end{overpic}
...
\begin{figure}
\centering
\begin{overpic}[width =0.8\columnwidth]{exp_2_ellipse.pdf}\end{overpic}
...
\begin{figure}
\centering
\begin{overpic}[width =0.7\columnwidth]{angle_box_plot.pdf}\end{overpic}
