...
\caption{\label{fig:Hetero_overall}
 This figure depicts the heterogeneous sensor system used for seismic data acquisition. It consists of two sensors the hexapod and the smart dart. These sensors have complementing features. The hexacopter shown is used as a deployment unit.}
