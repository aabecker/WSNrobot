...
\thanks{$^{2}$Department of Earth and Atmospheric Sciences, University of Houston, 4800 Calhoun Rd, Houston, TX 77004, USA
        {\tt\small \{skvenkatasudarshan, vjmontano, anguien43, msmcclimans, lchang13, rrstewar, atbecker\}@uh.edu}}%
}
...
We propose an autonomous heterogeneous sensor deployment system using UAVs to plant immobile sensors and deploy mobile sensors.
