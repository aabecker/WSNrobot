...
\begin{figure} \centering
 ...
 \caption{Targeting accuracy.  Circles show landing locations of 24 darts, each commanded to drop at the same GPS location. The mean position is marked by a diamond  with  covariance ellipses for  $\sigma$ and 2$\sigma$.
