...
\section{Algorithm}
Let us consider $r$ UVs servicing the Wireless Sensor Network and let $\mathbf{p}_i^r$ be the position of the $\mathbf{i}^{th}$ waypoint of the $\mathbf{r}^{th}$ UV. Servicing includes recharging the nodes and collecting a part of the data that the nodes are about to transmit to the sink there by reducing the power expenditure in the sensor nodes. The algorithm help in formulating an optimal path to visit the sensor nodes in the WSN depending on the interesting regions. Waypoints are a set of points that define the path for each UV $r$, the robot travels in straight lines in between two neighboring waypoints. At each step, we compute the Voronoi partition defined by the waypoints, with one partition assigned to each waypoint. We define an interesting function  $\phi(\mathbf{q})$ that commands the usefulness of a location on the map for servicing the WSN.

We compute the mass, mass-moment, and centroid of the $V_i^r$ partition as follows:
...
\begin{figure}\centering
  \includegraphics[width=0.49\columnwidth]{1_1}
    \includegraphics[width=0.49\columnwidth]{1_2}
      \includegraphics[width=0.49\columnwidth]{1_3}
        \includegraphics[width=0.49\columnwidth]{1_4}
         \includegraphics[width=0.49\columnwidth]{1_5}
           \includegraphics[width=0.49\columnwidth]{1_6}
...
%\begin{figure}\centering
%  \includegraphics[width=0.49\coloumnwidth]{1_1}
%  \includegraphics[width=0.49\coloumnwidth]{1_2}
 % \includegraphics[width=0.49\coloumnwidth]{1_3}
 %  \includegraphics[width=0.49\coloumnwidth]{1_4}
 %   \includegraphics[width=0.49\coloumnwidth]{1_5}
  %    \includegraphics[width=0.49\coloumnwidth]{1_6}
