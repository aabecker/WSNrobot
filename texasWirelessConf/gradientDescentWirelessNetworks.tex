...
\mathbf{H} = \sum\limits_{r=1}^N\sum\limits_{i=1}^{n(r)} \int_{V_i^r}\frac{\mathbf{W}_s}{2}\|\mathbf{q}-p_i^r\|^2&\phi(\mathbf{q}) d\mathbf{q}&+\nonumber\\
