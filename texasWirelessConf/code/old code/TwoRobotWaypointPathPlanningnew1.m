function TwoRobotWaypointPathPlanningnew1()
...
%    waypoints1=20*[x1',y1'];
  ...
  n1=10;
   ...
   waypoints1 = 10*[cos(theta1),sin(theta1)];
%    n2 = 10;
...
cellsz = mY(2) - mY(1);
sensors1=[0,0;-2,2;2,2;-2,-2;2,-2;-10,-10;10,10;-8,-10;-10,-8;8,10;10,8;-10,10;-10,8;-8,8;10,-10;10,-8;8,-8];%Intresting points  ;-6,6;-8,8;-4,8;-8,4;-4,4;6,-6;8,-8;4,-8;8,-4;4,-4;
...
for iter = 1:2000 % here for these iterations we calculate the previous and next neighbour for each waypoint
    ...
    T=zeros(size(WAYPOINTS,1),2);
    for i= 1:nwaypts1        %errors
        if(WAYPOINTS(1:end,:)==T(1:end,:))
        e_vals1(i,:)= [0 0] ;
        end
